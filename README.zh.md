...
| 💎 L3 板块气泡 | 四象限增长×利润×壁垒 | 半导体材料（12个细分赛道） |
...
| **L3 板块气泡** 💎 | 四象限散点 | "哪个赛道最赚钱？" | 增长↑×利润→×壁垒(面积)，龙头金色高亮 |
...
> *"你是一个产业分析可视化专家。用 D3.js 为 [产业名] 生成交互式 HTML 图表。使用 4 种递进模式：L1 辐射全景、L2 分层产业链、L3 四象限板块气泡、L4 四象限公司气泡。包含增长×利润×壁垒评分。深色科技风。"*
...
### 自定义配置
- **评分**：自己提供增长/利润/壁垒数据，或让 AI 基于行业知识自动评分
